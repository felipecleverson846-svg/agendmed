...
import { Banknote, CalendarCheck2, ChevronLeft, ChevronRight, Folder, List, Settings, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className='flex min-h-screen w-full'>
        ...
        <div className='mb-6 mt-4'>
          {!isCollapsed && (
            <span className='text-2xl font-bold'>
              <span className='text-black'>Agend</span>
      ...
      <div className={clsx("flex flex-1 flex-col transition-all duration-300", {
        ...
        <main className='flex-1 py-4 px-2 md:p-6 overflow-y-auto'>
          {children}
        </main>
